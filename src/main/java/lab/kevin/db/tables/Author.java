...
public class Author extends TableImpl<AuthorRecord> {
    ...
    private static final long serialVersionUID = -1353877753;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.SYS_IDX_SYS_PK_10102_10104);
    }
    ...
    public List<UniqueKey<AuthorRecord>> getKeys() {
        return Arrays.<UniqueKey<AuthorRecord>>asList(Keys.SYS_PK_10102);
    }
