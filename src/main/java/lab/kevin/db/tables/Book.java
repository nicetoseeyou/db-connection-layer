...
public class Book extends TableImpl<BookRecord> {
    ...
    private static final long serialVersionUID = -186985966;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.SYS_IDX_FK_BOOK_AUTHOR_10119, Indexes.SYS_IDX_FK_BOOK_LANGUAGE_10121, Indexes.SYS_IDX_SYS_PK_10108_10113);
    }
    ...
    public List<UniqueKey<BookRecord>> getKeys() {
        return Arrays.<UniqueKey<BookRecord>>asList(Keys.SYS_PK_10108);
    }
