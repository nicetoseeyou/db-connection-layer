...
public class BookStore extends TableImpl<BookStoreRecord> {
    ...
    private static final long serialVersionUID = -1885662528;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.SYS_IDX_SYS_CT_10124_10127);
    }
    ...
    public List<UniqueKey<BookStoreRecord>> getKeys() {
        return Arrays.<UniqueKey<BookStoreRecord>>asList(Keys.SYS_CT_10124);
    }
